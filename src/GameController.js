...
function GameController({ onPlusRun, onMinusRun, onToggleTimer, onOk, onExit, isTimerRunning, currentPlayerName, currentTurn, isVisible, onToggleVisibility, gameEnded = false, currentScore = 0, runCount = 0, targetScore = 30 }) {
        ...
        <div className="game-controller">
          ...
          <div className="controller-buttons top-buttons">
            <button 
              ...
              disabled={gameEnded}
              style={{ opacity: gameEnded ? 0.5 : 1, cursor: gameEnded ? 'not-allowed' : 'pointer' }}
            >
            ...
            <button 
              ...
              onClick={onPlusRun}
              title={isPlusDisabled ? "Hedef puana ulaşıldı" : "Run Sayısını Artır"}
              disabled={isPlusDisabled}
              style={{ opacity: isPlusDisabled ? 0.5 : 1, cursor: isPlusDisabled ? 'not-allowed' : 'pointer' }}
            >
              <span className="btn-symbol">+</span>
          ...
          {/* Exit Butonu */}
          <div className="controller-buttons exit-button-container">
            <button 
              className="controller-btn exit-btn"
              onClick={onExit}
              title="Maçı Sonlandır ve Çık"
            >
              <span className="btn-symbol">✕</span>
