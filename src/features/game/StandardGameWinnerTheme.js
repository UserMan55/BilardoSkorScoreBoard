...
function StandardGameWinnerTheme({
  player1Name,
  player2Name,
  targetScore,
  targetRack,
  ...
  return (
    <div style={{
      ...
      {/* Oyun Sonu Overlay - KEEP THIS for actual game end */}
      {gameEnded && (
        <div style={{
          position: 'fixed',
          top: 0,
      ...
      <div style={{
        ...
        <div style={{
            ...
            <div>Hedef: {targetScore}</div>
            <div style={{ fontSize: '24px', letterSpacing: '2px' }}>CANLI SKOR</div>
            <div>İstaka Limiti: {targetRack}</div>
        </div>
        ...
        <div style={{
          ...
          {/* Player 1 Card */}
          <div style={{
            background: currentTurn === 0 ? 'rgba(255, 255, 255, 0.1)' : 'rgba(255, 255, 255, 0.05)',
            border: currentTurn === 0 ? '2px solid #FFFFFF' : '2px solid rgba(255, 255, 255, 0.2)',
            borderRadius: '15px',
            padding: '20px',
            boxShadow: currentTurn === 0 ? '0 0 20px rgba(255, 255, 255, 0.3)' : 'none',
            transition: 'all 0.3s ease'
          }}>
            <div style={{
              fontSize: '28px',
              ...
              {currentTurn === 0 && <span style={{fontSize: '20px'}}>🎱</span>}
              {player1Name}
            </div>
            <div style={{ color: '#FFFFFF', fontSize: '18px', marginBottom: '10px' }}>
              <span style={{ color: '#888' }}>Skor:</span> <span style={{ fontWeight: 'bold', fontSize: '48px', color: '#FFD700', display: 'block', lineHeight: '1.2' }}>{player1Score}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: '15px' }}>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>HR1</span> 
                    <span style={{ fontWeight: 'bold', color: '#4ECDC4', fontSize: '20px' }}>{player1Stats.hr1}</span>
                </div>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>HR2</span> 
                    <span style={{ fontWeight: 'bold', color: '#4ECDC4', fontSize: '20px' }}>{player1Stats.hr2}</span>
                </div>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>AVG</span> 
                    <span style={{ fontWeight: 'bold', color: '#F39C12', fontSize: '20px' }}>{player1AVG}</span>
                </div>
            </div>
            {/* Timeout Indicators */}
             <div style={{ marginTop: '15px', display: 'flex', justifyContent: 'center', gap: '5px' }}>
                {[...Array(2)].map((_, i) => (
                  <div key={i} style={{
                    ...
                    background: i < player1TimeoutLeft ? '#4ECDC4' : '#444'
                  }} />
                ))}
             </div>
          </div>

          {/* Center Column (Inning & Run) */}
          <div style={{
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            ...
            <div style={{
              ...
              <div style={{ color: 'white', fontSize: '16px', fontWeight: 'bold', marginBottom: '5px' }}>İSTAKA</div>
              <div style={{ color: '#FFD700', fontSize: '42px', fontWeight: 'bold' }}>{inning}</div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ color: '#888', fontSize: '14px', marginBottom: '5px' }}>SERİ (RUN)</div>
                <div style={{ color: '#FFF', fontSize: '36px', fontWeight: 'bold' }}>{runCount}</div>
            </div>
          ...
          {/* Player 2 Card */}
          <div style={{
            background: currentTurn === 1 ? 'rgba(255, 215, 0, 0.1)' : 'rgba(255, 255, 255, 0.05)',
            border: currentTurn === 1 ? '2px solid #FFD700' : '2px solid rgba(255, 255, 255, 0.2)',
            borderRadius: '15px',
            padding: '20px',
            boxShadow: currentTurn === 1 ? '0 0 20px rgba(255, 215, 0, 0.3)' : 'none',
            transition: 'all 0.3s ease'
          }}>
            <div style={{
              fontSize: '28px',
              ...
              {currentTurn === 1 && <span style={{fontSize: '20px'}}>🎱</span>}
              {player2Name}
            </div>
            <div style={{ color: '#FFFFFF', fontSize: '18px', marginBottom: '10px' }}>
              <span style={{ color: '#888' }}>Skor:</span> <span style={{ fontWeight: 'bold', fontSize: '48px', color: '#FFD700', display: 'block', lineHeight: '1.2' }}>{player2Score}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: '15px' }}>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>HR1</span> 
                    <span style={{ fontWeight: 'bold', color: '#4ECDC4', fontSize: '20px' }}>{player2Stats.hr1}</span>
                </div>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>HR2</span> 
                    <span style={{ fontWeight: 'bold', color: '#4ECDC4', fontSize: '20px' }}>{player2Stats.hr2}</span>
                </div>
                <div style={{ color: '#FFFFFF', fontSize: '16px' }}>
                    <span style={{ color: '#888', display: 'block', fontSize: '12px' }}>AVG</span> 
                    <span style={{ fontWeight: 'bold', color: '#F39C12', fontSize: '20px' }}>{player2AVG}</span>
                </div>
            </div>
             {/* Timeout Indicators */}
             <div style={{ marginTop: '15px', display: 'flex', justifyContent: 'center', gap: '5px' }}>
                {[...Array(2)].map((_, i) => (
                  <div key={i} style={{
                    width: '12px', height: '12px', borderRadius: '50%',
                    background: i < player2TimeoutLeft ? '#4ECDC4' : '#444'
                  }} />
                ))}
             </div>
          </div>
...
export default StandardGameWinnerTheme;
